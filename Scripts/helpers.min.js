...
/*! fancyBox v3.3.5 fancyapps.com | fancyapps.com/fancybox/#license */
!function(t, e, n, o) {
    "use strict";
    function i(t, e) {
        var o, i, a = [], s = 0;
...
/*Browser alert*/
function upgrade() {
    $("body").append('<div style="position:fixed; top:0; top:0; z-index:9999999; padding:5px; text-align:center; background:#fbf98e; width:100%; font:12px/16px arial; border-bottom:1px solid orange">Oops..!! You are using <b><i>' + navigator.sayswho + "</i></b>, which is an Old version. Please upgrade your browser to increase safety &amp; better browsing experience.</div>").css('padding-top', '25px')
}
navigator.sayswho = function() {
    var e = navigator.userAgent, t, n = e.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [];
    ...
    if ((t = e.match(/version\/(\d+)/i)) != null)
        n.splice(1, 1, t[1]);
    return n.join(" ")
}();
var dgA = navigator.sayswho.split(" ");
if (dgA[0] == "Chrome" && dgA[1] <= 64 && document.location.pathname.length == 1) {
    setTimeout(upgrade, 5000)
}
if (dgA[0] == "Opera" && dgA[1] <= 51 && document.location.pathname.length == 1) {
    setTimeout(upgrade, 5000)
}
if (dgA[0] == "Safari" && dgA[1] <= 10 && document.location.pathname.length == 1) {
    setTimeout(upgrade, 5000)
}
if (dgA[0] == "MSIE" && dgA[1] <= 11 && document.location.pathname.length == 1) {
    navigator.sayswho = "Internet Explorer " + dgA[1];
    setTimeout(upgrade, 5000)
}
if (dgA[0] == "Firefox" && dgA[1] <= 58 && document.location.pathname.length == 1) {
    setTimeout(upgrade, 5000)
}
/*Custom*/
$(".cms_area table").addClass("table table-bordered table-striped table-hover");
